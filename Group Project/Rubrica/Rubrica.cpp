...
public:
    ...
    void stampaVoce()
    {
        cout << "Cognome:\t" << cognome << endl
             << "Nome:\t\t" << nome << endl
             << "Tel_fisso:\t" << telFisso << endl
             << "Tel_mobile:\t" << telMobile << endl
             << endl;
        cout << "---------------------------------------------------------------------------------------------------------" << endl
             << endl;
    }
...
void stampaVoceInFile(Rubrica rubrica[rubricaSize])
{
    ...
    for (int i = 0; i < rubricaCurrentSize; i++)
    {
        if (nomeCerca == rubrica[i].nomeValue() && cognomeCerca == rubrica[i].cognomeValue())
        {
            ...
            file << "Cognome:\t" << rubrica[i].cognomeValue() << endl
                 << "Nome:\t\t" << rubrica[i].nomeValue() << endl
                 << "Tel_fisso:\t" << rubrica[i].telFissoValue() << endl
                 << "Tel_mobile:\t" << rubrica[i].telMobileValue() << endl
                 << endl;
            file << "---------------------------------------------------------------------------------------------------------" << endl
                 << endl;
            found = true;
